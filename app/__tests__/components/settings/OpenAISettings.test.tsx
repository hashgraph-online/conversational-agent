...
import { OpenAISettings } from '@/renderer/pages/settings/OpenAISettings'
...
describe('OpenAISettings', () => {
  ...
  it('should render all form fields', () => {
    ...
    expect(screen.getByText('Configure your OpenAI API settings for the conversational agent.')).toBeInTheDocument()
  ...
  it('should show security note for API key', () => {
    ...
    expect(screen.getByText('Your API key is encrypted and stored securely using the system keychain.')).toBeInTheDocument()
  })

  it('should show model cost information', () => {
    render(<OpenAISettings />)

    expect(screen.getByText('GPT-4o is the latest and most capable model. GPT-4 provides great responses but costs more per token than GPT-3.5 Turbo.')).toBeInTheDocument()
  })
