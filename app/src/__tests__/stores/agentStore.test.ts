...
import { useAgentStore, Message } from '../../renderer/stores/agentStore'
...
describe('agentStore', () => {
  ...
  describe('Agent Connection', () => {
    it('should connect successfully', async () => {
      ...
      mockElectron.connectAgent.mockResolvedValue({
        success: true,
  ...
  describe('Message Sending', () => {
    it('should send message when connected', async () => {
      ...
      mockElectron.sendMessage.mockResolvedValue(assistantMessage)
    ...
    it('should handle send message error', async () => {
      ...
      mockElectron.sendMessage.mockRejectedValue(error)
  ...
  describe('Message ID Generation', () => {
    it('should generate unique message IDs', () => {
      ...
      mockElectron.sendMessage.mockResolvedValue(null)
