import { MCPRegistryService } from '../../main/services/MCPRegistryService'
import { MCPCacheManager } from '../../main/services/MCPCacheManager'

jest.mock('../../main/services/MCPCacheManager', () => ({
  MCPCacheManager: {
    getInstance: jest.fn()
  }
}))
