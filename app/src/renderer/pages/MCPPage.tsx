        ...
        <div className="container mx-auto px-6 py-8 max-w-6xl">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center space-y-4">
              ...
              <Typography variant="body1" color="muted">Loading MCP servers...</Typography>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='container mx-auto px-6 py-8 max-w-6xl'>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <Typography variant='body2' className='text-muted-foreground'>
                  MCP servers extend your agent with powerful capabilities like file system access, 
                  web browsing, database connections, and code execution. Browse the catalog to discover 
                  available servers or add your own custom server.
                </Typography>
              </div>
            </div>
          </motion.div>
        ...
        <Card className="shadow-lg">
          ...
          <div className="border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
            <nav className="flex space-x-4 sm:space-x-8 px-4 sm:px-6 min-w-max" role="tablist" aria-label="MCP server tabs">
              {tabs.map((tab, index) => {
                const Icon = tab.icon;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              <div className="space-y-4">
                <div>
                  <Typography variant="h3" className="text-lg font-semibold mb-2 text-[#5599fe]">
                    Model Context Protocol
                  </Typography>
                  <Typography variant="body1" className="text-gray-600 dark:text-gray-400">
                    The Model Context Protocol (MCP) is an open standard that enables seamless integration 
                    between AI assistants and external data sources and tools. It provides a universal way 
                    for AI models to access and interact with various services.
                  </Typography>
                </div>

                <div>
                  <Typography variant="h3" className="text-lg font-semibold mb-2 text-[#48df7b]">
                    Key Benefits
                  </Typography>
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li className="flex items-start gap-2">
                      ...
                      <Typography variant="body2">
                        <strong>Enhanced Capabilities:</strong> Connect your agent to databases, APIs, file systems, and more
                      </Typography>
                    </li>
                    <li className="flex items-start gap-2">
                      <FiShield className="w-4 h-4 text-[#48df7b] mt-0.5 flex-shrink-0" />
                      <Typography variant="body2">
                        <strong>Secure Integration:</strong> Maintain control over what data and tools your agent can access
                      </Typography>
                    </li>
                    <li className="flex items-start gap-2">
                      <FiPackage className="w-4 h-4 text-[#48df7b] mt-0.5 flex-shrink-0" />
                      <Typography variant="body2">
                        <strong>Modular Design:</strong> Add or remove capabilities without modifying core agent logic
                      </Typography>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <Typography variant="h3" className="text-lg font-semibold mb-2 text-[#a679f0]">
                    Popular MCP Servers
                  </Typography>
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Typography variant="body2" className="font-medium">GitHub</Typography>
                      </div>
                      <Typography variant="caption" className="text-gray-500 dark:text-gray-400">
                    ...
                    <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Typography variant="body2" className="font-medium">PostgreSQL</Typography>
                      </div>
                      <Typography variant="caption" className="text-gray-500 dark:text-gray-400">
                    ...
                    <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Typography variant="body2" className="font-medium">Custom</Typography>
                      </div>
                      <Typography variant="caption" className="text-gray-500 dark:text-gray-400">
                ...
                <div className="p-4 bg-gradient-to-br from-[#5599fe]/10 to-[#48df7b]/10 rounded-lg border border-[#5599fe]/20">
                  <Typography variant="body2" className="text-gray-700 dark:text-gray-300">
                    <strong>Getting Started:</strong> Click the "Add Server" button to configure your first MCP server. 
                    Each server extends your agent with new capabilities that can be used during conversations.
                  </Typography>
                </div>
              </div>
            </div>
