...
const tabGradients = {
  hedera: 'from-[hsl(var(--brand-secondary))] to-[hsl(var(--brand-primary))]',
  llm: 'from-[hsl(var(--brand-primary))] to-[hsl(var(--brand-accent))]',
  advanced: 'from-[hsl(var(--brand-accent))] to-[hsl(var(--brand-secondary))]'
}
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-6 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          <Typography
            variant="h1"
            className="text-3xl font-bold mb-4 bg-gradient-to-r from-[hsl(var(--brand-secondary))] via-[hsl(var(--brand-primary))] to-[hsl(var(--brand-accent))] bg-clip-text text-transparent"
            noMargin
          >
            Settings
          </Typography>
                ...
                return (
                  <motion.button
                    ...
                    className={cn(
                      ...
                      "transition-all focus:outline-none focus:ring-2 focus:ring-[hsl(var(--primary))]/50 focus:rounded-t-md min-h-[44px] touch-manipulation relative",
                      isActive
