    ...
    return (
      <Card
        ...
        className={cn(
          ...
          plugin.enabled && "border-[hsl(var(--primary))]/30 bg-gradient-to-br from-[hsl(var(--primary))]/5 to-transparent"
        )}
      >
          ...
          <div className="flex items-start justify-between mb-1.5">
            ...
            <Button
              ...
              className={cn(
                ...
                plugin.enabled
                  ? "text-primary hover:text-[hsl(var(--primary))]/90"
          ...
          {progress && (
            <div className="mb-2">
              <div className="flex items-center justify-between text-xs mb-1">
                ...
                {progress.progress && <span className="text-primary">{progress.progress}%</span>}
              </div>
        ...
        <CardContent className="p-3">
          ...
          {result.score && (
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex items-center gap-1">
                <div className="h-1 w-16 bg-muted rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[hsl(var(--primary))]/70"
          ...
          {!installed && (
            <Button
              ...
              className="h-6 px-3 text-xs bg-primary text-primary-foreground hover:bg-[hsl(var(--primary))]/90 border-0"
            >
              {installing ? (
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-6 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <Typography variant="h1" className="text-3xl font-bold bg-gradient-to-r from-[hsl(var(--brand-secondary))] via-[hsl(var(--brand-primary))] to-[hsl(var(--brand-accent))] bg-clip-text text-transparent">
                Plugins
              </Typography>
              <div className="px-2 py-1 bg-[hsl(var(--primary))]/20 text-primary rounded-md text-xs font-semibold">
                COMING SOON
              </div>
            </div>
            ...
            <div className="flex items-center p-1 bg-muted rounded-lg opacity-50 pointer-events-none">
              <Button
                ...
                className={cn(
                  "transition-all",
                  viewMode === 'installed' && "bg-primary text-primary-foreground hover:bg-[hsl(var(--primary))]/90"
                )}
              >
              ...
              <Button
                ...
                className={cn(
                  "transition-all",
                  viewMode === 'catalog' && "bg-primary text-primary-foreground hover:bg-[hsl(var(--primary))]/90"
                )}
              >
          ...
          <div className="p-4 bg-gradient-to-br from-[hsl(var(--primary))]/20 to-[hsl(var(--primary))]/10 rounded-lg border-2 border-[hsl(var(--primary))]/30">
            <div className="flex items-start gap-3">
              <Info className="h-5 w-5 text-primary mt-0.5" />
              <div>
                <Typography variant="body1" className="font-semibold text-primary mb-1">
        ...
        <div className="text-center py-8 mb-6 bg-gradient-to-br from-[hsl(var(--primary))]/5 to-[hsl(var(--primary))]/10 rounded-xl border border-[hsl(var(--primary))]/20">
          <div className="max-w-md mx-auto">
            <div className="w-16 h-16 bg-gradient-to-br from-[hsl(var(--primary))]/20 to-[hsl(var(--primary))]/10 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[hsl(var(--primary))]/10 text-primary rounded-full text-sm">
                  ...
                  {isLoading ? (
                    ...
                    <Card className="border-dashed border-2">
                      <CardContent className="p-12 text-center">
                        <div className="w-16 h-16 bg-gradient-to-br from-[hsl(var(--primary))]/20 to-[hsl(var(--primary))]/10 rounded-xl flex items-center justify-center mx-auto mb-3">
                        ...
                        <Button
                          ...
                          size="sm"
                          className="bg-primary text-primary-foreground hover:bg-[hsl(var(--primary))]/90 border-0"
                        >
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Typography variant="body2" className="text-xs font-medium text-primary">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2">
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full justify-start h-8 text-xs border-[hsl(var(--accent))]/30 hover:bg-[hsl(var(--accent))]/5"
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full justify-start h-8 text-xs border-[hsl(var(--primary))]/30 hover:bg-[hsl(var(--primary))]/5"
                      onClick={() => setViewMode('catalog')}
                    >
              ...
              <Card className="bg-gradient-to-br from-[hsl(var(--primary))]/10 to-[hsl(var(--primary))]/5 border-[hsl(var(--primary))]/20">
                <CardContent className="p-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-1 h-1 rounded-full bg-[hsl(var(--primary))]/70" />
                      <Typography variant="body2" className="text-xs text-muted-foreground">
                        Custom registries
                      </Typography>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-1 h-1 rounded-full bg-[hsl(var(--primary))]/50" />
                      <Typography variant="body2" className="text-xs text-muted-foreground">
                        Permissions
                      </Typography>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-1 h-1 rounded-full bg-[hsl(var(--primary))]/30" />
                      <Typography variant="body2" className="text-xs text-muted-foreground">
                        Advanced config
                      </Typography>
                    </div>
