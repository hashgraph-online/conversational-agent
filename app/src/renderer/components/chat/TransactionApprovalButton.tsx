  ...
  onReject,
    ...
    useEffect(() => {
        ...
        try {
          ...
          if (scheduleInfo && scheduleInfo.transaction_body) {
            ...
            const parsedTransaction: ParsedTransaction = {
              ...
              tokenAirdrop: (parsedTx as any).tokenAirdrop,
            };
      ...
      const parseTransactionBytes = async (): Promise<void> => {
        ...
        setIsLoadingDetails(true);
        try {
          // Fallback to parseTransactionBody if parseTransactionBytes is unavailable
          const parsedTx = await (TransactionParser as any).parseTransactionBytes
            ? await (TransactionParser as any).parseTransactionBytes(transactionBytes)
            : await TransactionParser.parseTransactionBody(transactionBytes);
        ...
        switch (transactionType) {
          ...
          case 'CRYPTOTRANSFER':
            if (
              ...
              return `Token transfer completed successfully! (${tokenCount} token${tokenCount > 1 ? 's' : ''
                } transferred)`;
            } else if (
          ...
          default:
            return `${transaction.humanReadableType || 'Transaction'
                ...
                <div className='flex items-start'>
                  ...
                  <div className='ml-3 sm:ml-4 overflow-hidden'>
                    ...
                    <Typography variant='caption' className={cn(
                      ...
                      {isAlreadyExecuted
                        ? `This scheduled transaction has already been executed${executedTimestamp
