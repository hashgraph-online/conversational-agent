...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-lg border px-2.5 py-1 text-xs font-medium font-mono w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none transition-all overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "border-[hsl(var(--primary))]/20 bg-[hsl(var(--primary))]/10 text-primary dark:bg-[hsl(var(--primary))]/20 dark:text-primary [a&]:hover:bg-[hsl(var(--primary))]/20 dark:[a&]:hover:bg-[hsl(var(--primary))]/30",
        secondary:
        ...
        outline:
          "border-current/20 text-foreground [a&]:hover:bg-white/10",
      },
    },
    defaultVariants: {
      variant: "default",
