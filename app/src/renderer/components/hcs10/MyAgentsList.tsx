      ...
      <CardHeader>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex-1 min-w-0">
            <CardTitle className="text-lg sm:text-xl">My Agent Profile</CardTitle>
          </div>
          <Button
            size="sm"
            variant="outline"
        ...
        {profiles.length === 0 ? (
          <div className="text-center py-12">
            ...
            <Typography variant="body2" className="text-muted-foreground mb-6 max-w-sm mx-auto">
              Get started by registering your AI agent profile on the Hedera network
            </Typography>
                  ...
                  <div className="flex-1 min-w-0 space-y-3">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Typography variant="body1" className="font-semibold text-base sm:text-sm">
                          {profile.name}
                        </Typography>
                        <Badge
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 text-sm text-muted-foreground">
                      ...
                      <span className="flex items-center gap-1.5">
                        ...
                        {formatDistanceToNow(profile.registeredAt, { addSuffix: true })}
                      </span>
                    </div>
                    ...
                    <div className="bg-gray-100/30 dark:bg-white/5 backdrop-blur-sm rounded-lg p-2 sm:p-3 border border-gray-200/50 dark:border-white/[0.06]">
                      <Typography variant="caption" className="font-mono text-gray-600 dark:text-gray-400 break-all text-[10px]">
                        {profile.accountId}
                      </Typography>
                    </div>
                  </div>
