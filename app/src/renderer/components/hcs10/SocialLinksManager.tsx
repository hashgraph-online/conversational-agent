 ...
 */
export function SocialLinksManager({ value = {}, onChange, disabled = false }: SocialLinksManagerProps) {
  const handleChange = (platform: 'twitter' | 'github' | 'website', url: string) => {
    onChange({
      ...value,
        ...
        {SOCIAL_PLATFORMS.map((platform) => (
          <div key={platform.value}>
            ...
            <Input
              ...
              onChange={(e) => handleChange(platform.value as keyof typeof value, e.target.value)}
